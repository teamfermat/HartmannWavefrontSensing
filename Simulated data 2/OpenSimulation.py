...
nameSaveFiles = "Simulation12072023 15_46_38"
# nameSaveFiles = "Simulation19022024 10_18_04"
...
plt.text(10,0.14,"$\sigma_{Theory}$",color= 'k',fontsize = 14,fontweight = 'light')
#%%
#fom[a,b,c,d,e], 
#a... wavelength
#b... Zernike coeff
...
for coeff_i in range(0,20,1):
    try:
        nameSaveFiles = "Simulation13072023 11_28_30"
    ...
    #%%
rmsFamilySS = 0.19 #nm - 0.16966932 above but below 2
